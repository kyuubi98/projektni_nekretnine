...
$nizNekretninaa = $nekretnina->vratiSve($mysqli);
...
<div class="container">
   <h3 class="text-center">Unos detalja termina</h3>
            ...
            <br>
            <input type="text" style="font-weight: bold; color: #343a40;" placeholder="Unesi nove detalje" class="form-control" name="novoRazgledanje">
            <br>
            <input type="submit" style="background-color: #868B8E; color: black;" class="form-control btn-primary" name="izmenaRazgledanja" value="Unesi podatke o terminu">
            </form>
...
<script>
  $(':input[name=izmenaRazgledanja]').click(function() {
                // process the form
                $("form").submit(function(event) {
                    // get the form data
                    var formData = {
                        'idRazgledanja' : $(':input[name=idRazgledanja]').val(),
                        'razgledanje'   : $(':input[name=novoRazgledanje]').val()
                    };
